...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
    ...
    <div class="bg-white border border-gray-100 rounded-xl p-5 relative overflow-hidden">
        <p class="text-[11px] font-semibold text-gray-400 flex items-center gap-1.5 mb-2">
            <i class="ph ph-bag-simple text-sm" style="color:#E02424"></i>
            Total Pesanan
        </p>
        <p class="text-[22px] font-extrabold text-navy mb-0.5"><?php echo $totalOrders; ?></p>
        <p class="text-[11px]" style="color:#E02424">Pesanan keseluruhan</p>
        <div class="hidden sm:block" style="height:32px; margin-top:8px;"><canvas id="spark-orders"></canvas></div>
    </div>
    ...
    <div class="bg-white border border-gray-100 rounded-xl p-5 relative overflow-hidden">
        ...
        <p class="text-[22px] font-extrabold text-navy mb-0.5"><?php echo FormatHelper::rupiah($totalSpent); ?></p>
        <p class="text-[11px]" style="color:#10b981">Akumulasi pengeluaran</p>
        <div class="hidden sm:block" style="height:32px; margin-top:8px;"><canvas id="spark-spent"></canvas></div>
    </div>

    <!-- Menunggu Konfirmasi -->
    <div class="bg-white border border-gray-100 rounded-xl p-5 relative overflow-hidden">
        <p class="text-[11px] font-semibold text-gray-400 flex items-center gap-1.5 mb-2">
            <i class="ph ph-clock text-sm" style="color:#f59e0b"></i>
            Menunggu Konfirmasi
        </p>
        <p class="text-[22px] font-extrabold text-navy mb-0.5"><?php echo $pendingOrders; ?></p>
        <p class="text-[11px]" style="color:#f59e0b">Pesanan belum diproses</p>
        <div class="hidden sm:block" style="height:32px; margin-top:8px;"><canvas id="spark-pending"></canvas></div>
    </div>

    <!-- Siap Diambil -->
    <div class="bg-white border border-gray-100 rounded-xl p-5 relative overflow-hidden">
        <p class="text-[11px] font-semibold text-gray-400 flex items-center gap-1.5 mb-2">
            <i class="ph ph-package text-sm" style="color:#0d9488"></i>
            Siap Diambil
        </p>
        <p class="text-[22px] font-extrabold text-navy mb-0.5"><?php echo $readyOrders; ?></p>
        <p class="text-[11px]" style="color:#0d9488">
            <?php echo $readyOrders > 0 ? "Segera ambil pesanan" : "Belum ada pesanan siap"; ?>
        </p>
        <div class="hidden sm:block" style="height:32px; margin-top:8px;"><canvas id="spark-ready"></canvas></div>
    </div>
