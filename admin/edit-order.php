...
$orderRaw = $orderAdminService->getById($id);
...
$allProducts = $orderAdminService->getActiveProducts();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $orderAdminService->updateOrder($id, $status, $productIds, $quantities, $items);
