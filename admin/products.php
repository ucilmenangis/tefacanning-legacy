        ...
        <table class="w-full text-left text-[12.5px] border-collapse">
            <thead>
                <tr>
                    ...
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Produk <i class="ph ph-caret-up-down text-[10px]"></i></th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Harga <i class="ph ph-caret-up-down text-[10px]"></i></th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Stok <i class="ph ph-caret-up-down text-[10px]"></i></th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Satuan</th>
                    <th
            ...
            <tbody>
                <?php foreach ($products as $prod): ?>
                    <tr>
                        <td class="w-9 px-3.5 py-3 border-b border-gray-50/50 text-gray-700 align-middle"><input
                        ...
                        <td class="font-semibold text-primary px-3.5 py-3 border-b border-gray-50/50 align-middle">
                            <?php echo FormatHelper::rupiah($prod['price']); ?></td>
                        <td class="px-3.5 py-3 border-b border-gray-50/50 align-middle"><span
                                class="inline-flex items-center justify-center min-w-[38px] px-2 py-0.5 rounded-full text-[11.5px] font-bold bg-emerald-50 text-emerald-600"><?php echo $prod['stock']; ?></span>
                        </td>
                        <td class="text-gray-500 px-3.5 py-3 border-b border-gray-50/50 align-middle">kaleng</td>
                        <td>
                            <?php if ($prod['is_active']): ?>
                                <span
                                    class="inline-flex items-center justify-center w-6 h-6 rounded-full border-2 border-teal-400 text-teal-400">
                                    <i class="ph ph-check text-xs"></i>
                                </span>
                            <?php else: ?>
                                <span
                                    class="inline-flex items-center justify-center w-6 h-6 rounded-full border-2 border-gray-300 text-gray-300">
                        ...
                        <td class="text-right px-3.5 py-3 border-b border-gray-50/50 align-middle">
                            <div class="relative inline-block text-left">
                                <button type="button"
                                    ...
                                    title="Opsi lainnya" onclick="toggleDropdown(event, this, '<?php echo $prod['id']; ?>')">
