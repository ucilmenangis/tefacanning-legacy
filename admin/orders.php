...
<div class="bg-white border border-gray-100 rounded-xl overflow-visible">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left text-[12.5px] border-collapse">
            <thead>
                <tr>
                    <th
                        class="w-9 text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        <input type="checkbox" class="w-[15px] h-[15px] accent-primary cursor-pointer" id="cb-all"
                            onchange="toggleAll(this)">
                    </th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        No. Pesanan <i class="ph ph-caret-up-down text-[10px]"></i></th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Pelanggan <i class="ph ph-caret-up-down text-[10px]"></i></th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Batch</th>
                    <th
                    ...
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Total <i class="ph ph-caret-up-down text-[10px]"></i></th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Diambil <i class="ph ph-caret-up-down text-[10px]"></i></th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Tanggal Order <i class="ph ph-caret-up-down text-[10px]"></i></th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Aksi</th>
                </tr>
            ...
            <tbody>
                <?php foreach ($orders as $row):
                    ...
                    ?>
                    <tr>
                        <td class="w-9 px-3.5 py-2 border-b border-gray-50/50 text-gray-700 align-middle"><input
                                type="checkbox" class="w-[15px] h-[15px] accent-primary cursor-pointer cb-row"></td>
                        <td class="font-bold text-navy px-3.5 py-2 border-b border-gray-50/50 align-middle">
                            <?php echo htmlspecialchars($row['order_number']); ?>
                        </td>
                        <td class="px-3.5 py-2 border-b border-gray-50/50 text-gray-700 align-middle">
                            <div class="font-semibold text-[12.5px] text-primary">
                        ...
                        <td class="px-3.5 py-2 border-b border-gray-50/50 text-gray-700 align-middle">
                            <span
                                class="text-[11px] bg-blue-50 text-blue-600 border border-blue-100 px-2 py-0.5 rounded font-semibold">
                        ...
                        <td class="font-mono text-[12px] text-gray-500 px-3.5 py-2 border-b border-gray-50/50 align-middle">
                            <?php echo htmlspecialchars($row['pickup_code']); ?>
                        </td>
                        <td class="font-semibold text-primary px-3.5 py-2 border-b border-gray-50/50 align-middle">
                            <?php echo FormatHelper::rupiah($row['total_amount']); ?>
                        </td>
                        <td class="text-gray-400 text-[12px] px-3.5 py-2 border-b border-gray-50/50 align-middle">
                            <?php echo $row['picked_up_at'] ? FormatHelper::tanggal($row['picked_up_at']) : '—'; ?>
                        </td>
                        <td
                            class="text-primary font-semibold text-[12px] px-3.5 py-2 border-b border-gray-50/50 align-middle">
                            <?php echo FormatHelper::tanggal($row['created_at']); ?>
                        </td>
                        <td class="text-right px-3.5 py-2 border-b border-gray-50/50 align-middle">
                            <div class="flex items-center gap-1 justify-end">
                                <a href="../api/download-pdf.php?id=<?php echo $row['id']; ?>"
                                    class="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[11.5px] font-semibold cursor-pointer transition-colors border-0 bg-transparent text-gray-400 hover:bg-red-50 hover:text-primary"
                                    title="Download PDF">
                                ...
                                <div class="relative inline-block text-left">
                                    <button type="button"
                                        ...
                                        title="Opsi lainnya"
                                        onclick="toggleDropdown(event, this, '<?php echo $row['id']; ?>')">
    ...
    <div id="dropdown-menu-global"
        ...
        <div class="py-1">
            <a id="dropdown-view-link" href="#"
                class="flex items-center gap-2 px-4 py-2 text-[12px] text-gray-600 hover:bg-gray-50 transition-colors">
                <i class="ph ph-eye text-base text-gray-400"></i> View
            </a>
            <a id="dropdown-edit-link" href="#"
                class="flex items-center gap-2 px-4 py-2 text-[12px] text-red-500 hover:bg-red-50 transition-colors font-medium">
                <i class="ph ph-note-pencil text-base text-red-400"></i> Edit
            </a>
            <button id="dropdown-delete-btn" type="button"
                class="flex items-center gap-2 px-4 py-2 text-[12px] text-red-600 hover:bg-red-50 transition-colors w-full text-left font-medium">
    ...
    <div
        ...
        <span>Showing 1 to
            <?php echo count($orders); ?> of
            <?php echo count($orders); ?> results
        </span>
