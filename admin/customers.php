            ...
            <thead>
                <tr>
                    ...
                    <th
                        ...
                        Nama <i class="ph ph-caret-up-down text-[10px]"></i></th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        WhatsApp</th>
                    <th
                    ...
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                        Pesanan <i class="ph ph-caret-up-down text-[10px]"></i></th>
                    <th
                        class="text-[11.5px] font-semibold text-gray-400 px-3.5 py-2.5 border-b border-gray-100 whitespace-nowrap bg-gray-50/50">
                    </th>
                </tr>
                ...
                <?php foreach ($customers as $row): ?>
                    <tr>
                        ...
                        <td class="px-3.5 py-3 border-b border-gray-50/50 text-gray-700 align-middle">
                            <div class="font-bold text-[13px] text-primary"><?php echo htmlspecialchars($row['name']); ?>
                            </div>
                            <div class="text-[11px] text-gray-400"><?php echo htmlspecialchars($row['organization']); ?>
                            </div>
                        </td>
                        <td class="px-3.5 py-3 border-b border-gray-50/50 text-gray-700 align-middle">
                        ...
                        <td class="px-3.5 py-3 border-b border-gray-50/50 text-gray-700 align-middle">
                            <span
                                class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold bg-emerald-50 text-emerald-600"><?php echo $row['order_count']; ?></span>
                        </td>
                        <td class="text-right px-3.5 py-3 border-b border-gray-50/50 align-middle">
                            <div class="relative inline-block text-left">
                                <button type="button"
                                    ...
                                    title="Opsi lainnya" onclick="toggleDropdown(event, this, '<?php echo $row['id']; ?>')">
