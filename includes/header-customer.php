...
<head>
    ...
    <style>
        ...
        /* ── Main & topbar ── */
        #main-content { margin-left: 220px; transition: margin-left 0.25s ease; }
        body.collapsed #main-content { margin-left: 64px; }
        #topbar { left: 220px; transition: left 0.25s ease; }
        ...
        .nav-item.active { background: #fef2f2; color: #E02424; }
        .nav-item.active .nav-icon { color: #E02424; }
...
<aside id="sidebar"
    ...
    <div class="flex items-center gap-2.5 px-4 h-[60px] border-b border-gray-100 flex-shrink-0">
        <div class="w-8 h-8 flex-shrink-0 rounded-lg bg-[#B91C1C] flex items-center justify-center">
            <span class="text-white text-[11px] font-extrabold leading-none">TC</span>
        </div>
...
════════════════════════════════════════════ -->
<header id="topbar"
        class="fixed top-0 right-0 h-[60px] bg-white border-b border-gray-100 z-30
               flex items-center justify-end px-6">
    <div class="flex items-center gap-3">
        <span class="text-[12px] font-medium text-navy hidden sm:block"><?php echo $customerData ? htmlspecialchars($customerData['name']) : 'Customer'; ?></span>
        ...
        <a href="<?php echo $basePath; ?>/logout.php" class="text-[11px] text-gray-400 hover:text-[#E02424] transition-colors" title="Logout">
