...
<head>
    ...
    <!-- Theme Detection -->
    <script>
        if (localStorage.getItem('customer-theme') === 'dark' || (!('customer-theme' in localStorage) && window.matchMedia('(prefers-color-scheme: dark)').matches)) {
        ...
        <div id="main-wrapper" class="flex-1 flex flex-col ml-0 md:ml-[220px] min-w-0 w-full overflow-hidden">
            ...
            <script>
                function toggleDarkMode() {
                    ...
                    localStorage.setItem('customer-theme', isDark ? 'dark' : 'light');
                }
