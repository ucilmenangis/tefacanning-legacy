...
<body class="font-sans text-gray-800 antialiased bg-white">
    ...
    <nav class="fixed top-0 w-full bg-white border-b border-gray-100 z-50">
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-[70px]">
                ...
                <div class="flex-shrink-0 flex items-center gap-3">
                    ...
                    <div class="flex flex-col justify-center">
                        <span class="text-[17px] font-bold text-[#B91C1C] leading-none mb-1 tracking-wide">TEFA Canning
                            SIP</span>
                        <span class="text-[12px] font-medium text-slate-400 leading-none">Politeknik Negeri
                            Jember</span>
                    </div>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-12">
                    <a href="#katalog"
                        class="text-[11px] font-semibold text-gray-500 hover:text-primary transition-colors tracking-widest uppercase">Produk</a>
                    <a href="#tentang"
                        class="text-[11px] font-semibold text-gray-500 hover:text-primary transition-colors tracking-widest uppercase">Tentang</a>
                    <a href="#batch"
                        class="text-[11px] font-semibold text-gray-500 hover:text-primary transition-colors tracking-widest uppercase">Info
                        Batch</a>
                    <a href="auth/login-customer.php"
                        class="px-5 py-2 text-[12px] font-semibold text-white bg-primary hover:bg-accent rounded-md shadow-sm transition-all">
                        Login
                    </a>
                </div>

                <button type="button" id="mobile-menu-button"
                    class="md:hidden inline-flex h-10 w-10 items-center justify-center rounded-lg border border-gray-100 text-navy hover:bg-red-50 hover:text-primary transition-colors"
            ...
            <!-- Mobile Menu -->
            <div id="mobile-menu"
                class="hidden md:hidden flex-col gap-1 border-t border-red-100 py-4 mt-2 rounded-lg shadow-sm">
                <a href="#katalog"
                    class="mobile-menu-link flex items-center justify-between rounded-lg px-3 py-3 text-[12px] font-bold uppercase tracking-widest text-gray-500 hover:bg-red-50 hover:text-primary transition-colors">
                    Produk
    ...
    <div class="relative pt-[140px] pb-24 overflow-hidden flex flex-col justify-center min-h-[90vh]">
        ...
        <div
            class="absolute inset-0 bg-gradient-to-tr from-rose-50/60 via-red-50/30 to-rose-50/60 blur-[100px] pointer-events-none -z-10 scale-110">
        </div>
        ...
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex justify-center">
            ...
            <div class="flex flex-col items-start text-left max-w-[750px] w-full">
                <!-- Badge -->
                <div
                    class="inline-flex items-center justify-center px-3 py-1.5 rounded-full bg-[#FFF5F5] border border-red-100 text-primary mb-6 shadow-sm">
                ...
                <p class="text-[16px] text-gray-500 max-w-[600px] leading-relaxed font-medium mb-10">
                    Sarden kaleng premium dari ikan lemuru segar, diproduksi oleh Teaching Factory Politeknik Negeri
                    Jember dengan standar mutu terjamin.
                </p>

                <!-- Buttons -->
                <div
                    class="flex w-full max-w-[220px] flex-col items-stretch gap-4 sm:w-auto sm:max-w-none sm:flex-row sm:items-center">
                    <a href="#katalog"
                        class="inline-flex w-full justify-center items-center px-6 py-3 rounded-lg text-[14px] font-bold text-white bg-[#E02424] hover:bg-red-100 hover:text-red-500 transition-all shadow-md shadow-red-500/20 sm:w-auto">
                        Lihat Produk
                        <i class="ph-bold ph-caret-down ml-2"></i>
                    </a>
                    <a href="#batch"
                        class="inline-flex w-full justify-center items-center px-6 py-3 rounded-lg bg-white border border-[#FCA5A5] hover:bg-red-50 transition-all text-primary shadow-[0_2px_10px_rgb(0,0,0,0.02)] sm:w-auto">
                    ...
                    <div
                        ...
                        <div class="p-8">
                            <div class="flex items-center gap-2 mb-4">
                                <?php if ($i === 0): ?>
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-semibold bg-primary text-white">
                                        TERLARIS
                                    </span>
                                <?php endif; ?>
                                <span
        ...
        <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <?php foreach ($batches as $batch): ?>
                    <div
                        class="bg-white rounded-2xl border border-red-100 p-6 flex flex-col hover:shadow-lg hover:shadow-red-500/5 transition-all">
                        <div class="flex items-center justify-between mb-5">
                            ...
                            <div
                                class="px-2.5 py-1 rounded-full bg-[#ECFDF5] flex items-center text-[10px] font-bold text-[#10B981] tracking-wide">
                        ...
                        <a href="customer/preorder.php"
                            class="mt-auto w-full flex items-center justify-center py-3.5 rounded-xl text-[13px] font-bold text-[#FFFFFF] bg-red-500 hover:bg-red-100 hover:text-red-500 transition-colors">
    ...
    <div class="py-12 bg-[#FFFBEB]">
        <div class="max-w-[900px] mx-auto px-6">
            <div class="flex flex-col sm:flex-row items-start gap-4">
                <div
                    class="flex-shrink-0 w-12 h-12 rounded-[14px] bg-[#FDE68A]/60 flex items-center justify-center text-[#D97706]">
                ...
                <div class="pt-1">
                    ...
                    <p class="text-[14px] text-[#B45309] leading-[1.8] font-medium max-w-[800px]">
                        Produk TEFA Canning diproduksi dalam lingkungan pembelajaran Teaching Factory. Produk telah
                        melalui proses quality control standar dan sterilisasi komersial, namun mungkin memiliki variasi
                        minor yang tidak memengaruhi kualitas dan keamanan pangan.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <p class="text-[15px] text-gray-500 leading-[1.8] mb-8 font-medium">
                        Teaching Factory (TEFA) Canning adalah unit produksi pembelajaran Politeknik Negeri Jember yang
                        memproduksi sarden kaleng berkualitas. Seluruh proses produksi dilakukan oleh mahasiswa di bawah
                        bimbingan dosen ahli.
                    </p>

                    <ul class="space-y-6">
                        <li class="flex items-start">
                            <div
                                class="flex-shrink-0 w-6 h-6 rounded-md bg-red-50 flex items-center justify-center mr-3 shadow-sm border border-red-50">
                                <i class="ph ph-check text-primary text-[12px]"></i>
                            </div>
                            <span class="text-[14px] text-gray-500 font-medium pt-0.5">Diproduksi dengan proses <strong
                                    class="text-gray-600 font-bold">sterilisasi komersial</strong> sesuai standar
                                industri</span>
                        </li>
                        <li class="flex items-start">
                            <div
                            ...
                            <span class="text-[14px] text-gray-500 font-medium pt-0.5"><strong
                                    class="text-gray-600 font-bold">Tanpa bahan pengawet</strong> — hanya bahan alami
                                pilihan</span>
                        </li>
                        <li class="flex items-start">
                            <div
                            ...
                            <span class="text-[14px] text-gray-500 font-medium pt-0.5">Menggunakan <strong
                                    class="text-gray-600 font-bold">ikan lemuru segar</strong> berkualitas tinggi</span>
                        </li>
                        <li class="flex items-start">
                            <div
                                class="flex-shrink-0 w-6 h-6 rounded-md bg-red-50 flex items-center justify-center mr-3 shadow-sm border border-red-50">
                            ...
                            <span class="text-[14px] text-gray-500 font-medium pt-0.5">Sistem <strong
                                    class="text-gray-600 font-bold">Pre-Order berbasis Batch</strong> menjamin kesegaran
                                produk</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="flex flex-col items-center justify-center gap-4">
                    <!-- Logos Container -->
                    <div
                        class="bg-white border border-gray-100 rounded-[32px] p-10 sm:p-14 shadow-sm w-full max-w-lg flex items-center justify-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
                ...
                <div class="md:col-span-1 pr-8">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div class="flex flex-col justify-center">
                            <span class="text-[16px] font-bold text-white leading-none mb-1 tracking-wide">TEFA Canning
                                SIP</span>
                            <span class="text-[12px] font-medium text-slate-400 leading-none">Politeknik Negeri
                                Jember</span>
                        </div>
                    ...
                    <p class="text-[#94A3B8] text-[12px] leading-relaxed">
                        Teaching Factory Canning adalah sarana pembelajaran industri di kampus yang menghasilkan produk
                        bernilai jual.
                    </p>
                    <a href="https://polije.ac.id"
                        class="text-[11px] text-[#94A3B8] hover:text-white mt-4 inline-block">www.polije.ac.id</a>
                </div>
                ...
                <div>
                    ...
                    <p class="text-[#94A3B8] text-[12px] leading-relaxed mb-4">
                        TEFA Canning, Jl. Mastrip, Kotak Pos 164, Krajan Timur, Sumbersari, Kec. Sumbersari, Kab.
                        Jember, Jawa Timur 68121
                    </p>
                    <a href="https://maps.app.goo.gl/p397wt11aVfuTCjt9" target="_blank"
                        class="text-primary text-[11px] hover:text-red-400 flex items-center">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="auth/login-customer.php"
                                class="text-[#94A3B8] hover:text-white text-[12px] mt-2 block">Login Pelanggan</a></li>
                        <li><a href="auth/login-admin.php" class="text-[#94A3B8] hover:text-white text-[12px]">Login
                                Admin</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="h-32 bg-[#1E293B] rounded-lg overflow-hidden border border-[#334155]">
                        <iframe src="https://maps.google.com/maps?q=-8.1556551,113.7268947&z=16&output=embed"
